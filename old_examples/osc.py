...
osc = sampler(pz_kmin=kmin,pz_kmax=kmax,gwb_karr=k_arr,
                ...
                y_low=-8,y_high=1,interpolation_method='CubicSpline',min_nodes=7,max_nodes=14
...
# ax2.set_ylim(1e-5,1.)
plt.savefig('osc_aic.pdf',bbox_inches='tight')
...
osc = sampler(pz_kmin=kmin,pz_kmax=kmax,gwb_karr=k_arr,
                 gwb_means=gwb_amp,gwb_cov=gwb_cov,
                 gwb_method='jax',gwb_method_kwargs=gwb_method_kwargs,
                y_low=-8,y_high=1,interpolation_method='CubicSpline',min_nodes=7,max_nodes=12,aic=False,
