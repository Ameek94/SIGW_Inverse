...
sample_data = np.load(f'{gwb_model}_w0p66_free_{num_nodes}.npz') #np.load(f'{gwb_model}_wfld_free_{num_nodes}.npz')
...
plt.savefig(f'{gwb_model}_wfld_0p66_{num_nodes}_posterior.pdf',bbox_inches='tight')
