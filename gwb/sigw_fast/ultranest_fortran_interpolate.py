...
sampler = ultranest.ReactiveNestedSampler(param_names, likelihood, prior,log_dir=f'./ultranest_{num_nodes}',resume=True)
result = sampler.run(dlogz=0.5,frac_remain=0.1)
